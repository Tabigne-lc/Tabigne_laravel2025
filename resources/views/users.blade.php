...
<head>
    ...
    <style>
        ...
        .btn-warning { background: #e5a4c2; border-color: #e5a4c2; color: white; }
        .btn-warning:hover { background: #d88aad; border-color: #d88aad; }
        .btn-danger { background: #4b70b4; border-color: #4b70b4; color: white; }
        .btn-danger:hover { background: #3d5a96; border-color: #3d5a96; }
    </style>
</head>
<body>
    <div class="nav-bar">
    ...
    <div class="container">
        <h1 class="text-center" style="color: #4b70b4;">User Management</h1>
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Rovi Hannz Tabigne</td>
                    <td>rovihannz@gmail.com</td>
                    <td>
